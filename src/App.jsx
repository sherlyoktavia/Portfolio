...
function App() {
  ...
  return (
    ...
    <div className="home lg:mt-10 py-30 sd:py-20 md:py-30 z-20" id="home">
        <div className="flex flex-col md:flex-row items-center justify-between sm:mx-4 md:mx-10 lg:mx-30">
          <div className="flex flex-col justify-center">
            ...
            <div className=" button p-4 md:p-10 flex gap-10 md:gap-20 animate__animated animate__fadeInUp animate__delay-1s">
              <a href="https://drive.google.com/file/d/1WZko_1mRWuc4z1shIJ5PvB7H5I4WHyBn/view?usp=sharing" target="_blank" className="border border-zinc-500 bg-sky-100 hover:bg-sky-700/60 hover:text-white rounded-xl p-2 md:p-4 xl:font-semibold">Download CV</a>
          ...
          <img src={Photo2} alt="Foto Profil" className="opacity-30 hidden md:block w-60 animate__animated animate__fadeInUp animate__delay-2s"/>
        </div>
    </div>
      ...
      <div>
        <div className="border rounded-2xl border-zinc-800/70 items-center justify-center mx-7 mb-2 p-2 lg:mx-30 md:mb-7 md:p-4 flex flex-col md:flex-row gap-5" data-aos="fade-right">
          <div className="flex flex-col ">
            <p className="text-base font-semibold md:font-bold md:text-2xl">ReBio</p>
            <hr className=""/>
            <p className="text-[14px] md:text-base text-justify mb-1 md:mb-2">A project to reducing organic waste, particularly household waste from residential areas.</p>
            <details>
              <summary className="text-[10px] md:text-[14px] text-justify mb-1 md:mb-4 text-black/60">See detail description</summary>
              <p className="text-[10px] md:text-[14px] text-justify mb-1 md:mb-4 text-black/60">This is a group project that created for participating in the DOW: Heroes of Innovation competition which successfully bring us to 6th place in the competition. ReBio mobile application built with Flutter and Firebase, residents of the cluster will be able to do monitoring eco-enzyme condition based on sensor analysis, collaborate to ensure the eco-enzyme remains in healthy state, and interact each other within the system. </p>
            </details>
            <a href="https://github.com/sherlyoktavia/ReBio" target="_blank" className="border rounded-xl p-1 px-2 font-light md:p-2 md:px-4 border-zinc-800/70 md:font-semibold bg-sky-100 text-center w-fit text-[14px] hover:bg-sky-700/60 hover:text-white">GitHub <i className="ri-github-fill"></i></a>
          </div>
          <img src={Rebio} alt="Rebio" className="h-30 md:h-50 lg:h-60 xl:h-75"/>
        </div>
        <div className="border-1 rounded-2xl border-zinc-800/70 items-center mx-7 mb-2 p-2 lg:mx-30 md:mb-7 md:p-5 flex flex-col md:flex-row justify-center gap-5" data-aos="fade-left">
          <div className="flex flex-col">
            <p className="text-base font-semibold md:font-bold md:text-2xl">CareerSprint</p>
            <hr className=""/>
            <p className="text-[14px] md:text-base text-justify mb-1 md:mb-2">Application to address employee retention and solve inefficient & suboptimal communication.</p>
            <details>
              <summary className="text-[10px] md:text-[14px] text-justify mb-1 md:mb-4 text-black/60">See detail description</summary>
              <p className="text-[10px] md:text-[14px] text-justify mb-1 md:mb-4 text-black/60">Employee retention become a major challenge faced by many big companies, also inefficient and suboptimal communication in the workplace. Progress management feature displays a progress bar that shows each team’s performance and allows team members to receive or give feedback on their performance that can be viewed directly by teammates. Training Roadmap feature, which utilizes AI to perform analysis based on performance results, feedback, and employee capabilities during doing tasks to provide training recommendations.</p>
            </details>
            <a href="https://drive.google.com/file/d/1wlk4aFj5jfGJCnPreHluwpoQwF5_tK3Z/view" target="_blank" className="border rounded-xl p-1 px-2 font-light md:p-2 md:px-4 border-zinc-800/70 md:font-semibold bg-sky-100 text-center w-fit text-[14px] hover:bg-sky-700/60 hover:text-white">Google Drive <i className="ri-drive-fill"></i></a>
          </div>
          <img src={CareerSprint} alt="CareerSprint" className="h-30 md:h-50 lg:h-60 xl:h-75"/>
        </div>
        <div className="border-1 rounded-2xl border-zinc-800/70 items-center mx-7 mb-2 p-2 lg:mx-30 md:mb-7 md:p-5 flex flex-col md:flex-row justify-center gap-5" data-aos="fade-right">
          <div className="flex flex-col">
            <p className="text-base font-semibold md:font-bold md:text-2xl">Weather Forecast Website</p>
            <hr className=""/>
            <p className="text-[14px] md:text-base text-justify mb-1 md:mb-2">A Website to predict weather conditions for the next 5 days also temperature and humidity for the next 5 hours based on the location.</p>
            <details>
              <summary className="text-[10px] md:text-[14px] text-justify mb-1 md:mb-4 text-black/60">See detail description</summary>
            ...
            <a href="https://github.com/sherlyoktavia/Weather-Forecast-Website" target="_blank" className="border rounded-xl p-1 px-2 font-light md:p-2 md:px-4 border-zinc-800/70 md:font-semibold bg-sky-100 text-center w-fit text-[14px] hover:bg-sky-700/60 hover:text-white">GitHub <i className="ri-github-fill"></i></a>
          </div>
          <img src={Weather} alt="Weather Forecast" className="w-50 md:w-60 lg:w-80 xl:w-93"/>
        </div>
        <div className="border-1 rounded-2xl border-zinc-800/70 items-center mx-7 mb-2 p-2 lg:mx-30 md:mb-7 md:p-5 flex flex-col md:flex-row justify-center gap-5" data-aos="fade-left">
          <div className="flex flex-col">
            <p className="text-base font-semibold md:font-bold md:text-2xl">Sobat</p>
            <hr className=""/>
            <p className="text-[14px] md:text-base text-justify mb-1 md:mb-2">Application to ensure efficient and targeted food distribution, reduce food waste, and encourage optimal consumption.</p>
            <details>
              <summary className="text-[10px] md:text-[14px] text-justify mb-1 md:mb-4 text-black/60">See detail description</summary>
              <p className="text-[10px] md:text-[14px] text-justify mb-1 md:mb-4 text-black/60">This application  connects food producers and distributors in the form of government agencies, and beneficiary communities. It also serves as an effort to reduce food waste, encourage optimal consumption of local food, and connect directly with small farmers/local food communities. There are two roles available when accessing the application: Authority (Government Agency) or Friend (General Public), each leading to a different application page based on their respective roles.</p>
            </details>
          ...
          <img src={Sobat} alt="Sobat" className="w-50 md:w-60 lg:w-75 xl:w-93"/>
        </div>
      </div>
      </div>
