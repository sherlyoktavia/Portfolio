...
function App() {
  ...
  return (
    ...
    <div className="home lg:mt-10 py-30 sd:py-20 md:py-30 z-20" id="home">
      ...
      <div>
        <div className="border rounded-2xl border-zinc-800/70 items-center justify-center mx-7 mb-2 p-2 lg:mx-30 md:mb-7 md:p-4 flex gap-5" data-aos="fade-right">
          <div className="flex flex-col ">
            <p className="text-xs sm:text-base font-semibold md:font-bold md:text-2xl">ReBio</p>
            <hr className=""/>
            <p className="text-[6px]  sm:text-[10px] md:text-base text-justify mb-1 md:mb-2">A project to reducing organic waste, particularly household waste from residential areas.</p>
            <details>
              <summary className="text-[6px] sm:text-[10px] md:text-[14px] text-justify mb-1 md:mb-4 text-black/60">See detail description</summary>
        ...
        <div className="border-1 rounded-2xl border-zinc-800/70 items-center mx-7 mb-2 p-2 lg:mx-30 md:mb-7 md:p-5 flex justify-center gap-5" data-aos="fade-left">
          <div className="flex flex-col">
            <p className="text-xs sm:text-base font-semibold md:font-bold md:text-2xl">CareerSprint</p>
            <hr className=""/>
            <p className="text-[6px] sm:text-[10px] md:text-base text-justify mb-1 md:mb-2">Application to address employee retention and solve inefficient & suboptimal communication.</p>
            <details>
              <summary className="text-[6px] sm:text-[10px] md:text-[14px] text-justify mb-1 md:mb-4 text-black/60">See detail description</summary>
        ...
        <div className="border-1 rounded-2xl border-zinc-800/70 items-center mx-7 mb-2 p-2 lg:mx-30 md:mb-7 md:p-5 flex justify-center gap-5" data-aos="fade-right">
          <div className="flex flex-col">
        ...
        <div className="border-1 rounded-2xl border-zinc-800/70 items-center mx-7 mb-2 p-2 lg:mx-30 md:mb-7 md:p-5 flex justify-center gap-5" data-aos="fade-left">
          <div className="flex flex-col">
            ...
            <hr className=""/>
            <p className="text-[6px] sm:text-[10px] md:text-base text-justify mb-1 md:mb-2">Application to ensure efficient and targeted food distribution, reduce food waste, and encourage optimal consumption.</p>
            <details>
              <summary className="text-[6px] sm:text-[10px] md:text-[14px] text-justify mb-1 md:mb-4 text-black/60">See detail description</summary>
