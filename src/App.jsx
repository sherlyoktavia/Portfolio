...
function App() {
  return (
    ...
    <div className="home lg:mt-10 py-30 sd:py-20 md:py-30 z-20 ">
        <div className="flex items-start justify-between sm:mx-4 md:mx-10 lg:mx-30">
          <div className="flex flex-col justify-center">
            ...
            <div className="button p-4 md:p-10 flex gap-10 md:gap-20">
          ...
          <img src={Photo} alt="Foto Profil" className="rounded-full w-20 h-20 sm:w-30 sm:h-30 md:w-45 md:h-45 object-cover"/>
        </div>
    </div>

        {/* About */}
      <div className="about pt-7 sm:pt-10 flex flex-col items-center z-20">
        <div>
      ...
      <div className="project pt-30 z-20">
        <p className="text-2xl md:text-5xl font-bold text-center pb-5 md:pb-10">My Project</p>
      <div>
        <div className="border rounded-2xl border-zinc-800/70 items-center mx-7 mb-2 p-2 lg:mx-30 md:mb-7 md:p-4 flex gap-5">
          <div className="flex flex-col">
            ...
            <a href="https://github.com/sherlyoktavia/ReBio" target="_blank" className="border rounded-xl p-1 px-2 font-light md:p-2 md:px-4 border-zinc-800/70 md:font-semibold bg-sky-100 text-center w-fit text-[6px] sm:text-[10px] md:text-base">GitHub <i className="ri-github-fill"></i></a>
          </div>
          <img src={Rebio} alt="Rebio" className="h-20 md:h-50 lg:h-60 xl:h-75"/>
        </div>
        <div className="border-1 rounded-2xl border-zinc-800/70 items-center mx-7 mb-2 p-2 lg:mx-30 md:mb-7 md:p-5 flex justify-between gap-5">
          <div className="flex flex-col">
            ...
            <a href="https://drive.google.com/file/d/1wlk4aFj5jfGJCnPreHluwpoQwF5_tK3Z/view" target="_blank" className="border rounded-xl p-1 px-2 font-light md:p-2 md:px-4 border-zinc-800/70 md:font-semibold bg-sky-100 text-center w-fit text-[6px] sm:text-[10px] md:text-base">Google Drive <i className="ri-drive-fill"></i></a>
          </div>
        ...
        <div className="border-1 rounded-2xl border-zinc-800/70 items-center mx-7 mb-2 p-2 lg:mx-30 md:mb-7 md:p-5 flex justify-between gap-5">
          <div className="flex flex-col">
            ...
            <a href="https://github.com/sherlyoktavia/Weather-Forecast-Website" target="_blank" className="border rounded-xl p-1 px-2 font-light md:p-2 md:px-4 border-zinc-800/70 md:font-semibold bg-sky-100 text-center w-fit text-[6px] sm:text-[10px] md:text-base">GitHub <i className="ri-github-fill"></i></a>
          </div>
      ...
      <div className="contact py-30 items-center flex flex-col z-20">
        ...
        <form action="https://formsubmit.co/sherly.willisa@binus.ac.id" method="POST" className="flex flex-col gap-5 border-2 border-zinc-400 rounded-2xl p-7 sm:p-10">
          ...
          <button type="submit" className="bg-sky-700/30 rounded-xl p-2 sm:p-4 sm:mt-4 font-semibold">Send Message <i className="ri-send-plane-2-line fill-zinc-400"></i></button>
        </form>
      </div>
